...
import net.sourceforge.ganttproject.ui.chart.canvas.Painter;
import net.sourceforge.ganttproject.ui.chart.grid.*;
import net.sourceforge.ganttproject.ui.chart.grid.OffsetManager.OffsetBuilderFactory;
import net.sourceforge.ganttproject.ui.chart.render.TextLengthCalculatorImpl;
import net.sourceforge.ganttproject.ui.chart.scene.DayGridSceneBuilder;
import net.sourceforge.ganttproject.ui.chart.scene.SceneBuilder;
import net.sourceforge.ganttproject.ui.chart.scene.TimelineSceneBuilder;
import net.sourceforge.ganttproject.ui.chart.text.TimeFormatter;
import net.sourceforge.ganttproject.ui.chart.text.TimeFormatters;
...
import net.sourceforge.ganttproject.model.time.TimeUnitFunctionOfDate;
