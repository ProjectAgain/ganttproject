...
public class CharSetMap {
   ...
   */
  private static final HashMap<String, String> commonMapper = new HashMap<>();
  /**
  ...
  public synchronized void setCharSet(String key, String charset) {
    ...
    mapper = mapper != null ? (HashMap<String, String>) mapper.clone() : new HashMap<>();
  ...
  protected synchronized void setCommonCharSet(String key, String charset) {
    HashMap<String, String> mapper = new HashMap<>(mappers[MAP_COM]);
    mapper.put(key, charset);
