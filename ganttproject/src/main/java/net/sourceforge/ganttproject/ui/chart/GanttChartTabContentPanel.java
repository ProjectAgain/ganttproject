...
import net.sourceforge.ganttproject.ui.action.BaselineDialogAction;
import net.sourceforge.ganttproject.ui.action.CalculateCriticalPathAction;
...
import net.sourceforge.ganttproject.ui.gui.view.GPView;
...
public class GanttChartTabContentPanel extends ChartTabContentPanel implements GPView {
  ...
  public GanttChartTabContentPanel(IGanttProject project, UIFacade workbenchFacade, TreeTableContainer treeFacade,
