...
import net.sourceforge.ganttproject.model.resource.ResourceEvent;
import net.sourceforge.ganttproject.model.resource.ResourceView;
...
import net.sourceforge.ganttproject.ui.action.*;
import net.sourceforge.ganttproject.ui.action.edit.EditMenu;
import net.sourceforge.ganttproject.ui.action.help.HelpMenu;
import net.sourceforge.ganttproject.ui.action.project.ProjectMenu;
import net.sourceforge.ganttproject.ui.action.resource.ResourceActionSet;
import net.sourceforge.ganttproject.ui.action.view.ViewCycleAction;
import net.sourceforge.ganttproject.ui.action.view.ViewMenu;
import net.sourceforge.ganttproject.ui.action.zoom.ZoomActionSet;
import net.sourceforge.ganttproject.ui.chart.*;
...
//    });
    ...
    addWindowListener(new WindowAdapter() {
      ...
      public void windowOpened(WindowEvent e) {
        ...
        getUiFacadeImpl().getDpiOption().addChangeValueListener(event -> SwingUtilities.invokeLater(
  ...
  private FXToolbar createToolbar() {
    ...
    final ArtefactAction newAction;
    {
      ...
      newAction = new ArtefactNewAction(
        () -> getTabs().getSelectedIndex() == UIFacade.GANTT_INDEX ? taskNewAction : resourceNewAction,
    ...
    final ArtefactAction deleteAction;
    {
      ...
      deleteAction = new ArtefactDeleteAction(
        () -> getTabs().getSelectedIndex() == UIFacade.GANTT_INDEX ? taskDeleteAction : resourceDeleteAction,
    ...
    final ArtefactAction propertiesAction;
    {
      ...
      propertiesAction = new ArtefactPropertiesAction(
        () -> getTabs().getSelectedIndex() == UIFacade.GANTT_INDEX ? taskPropertiesAction : resourcePropertiesAction,
...
//    GPLogger.logSystemInformation();
    ...
    return !cmdlineApplication.export(mainArgs);
