...
*/
package net.sourceforge.ganttproject.app
...
private fun getResourceBundle(locale: Locale, withFallback: Boolean): ResourceBundle? {
  return try {
    ...
    LoggerFactory.getLogger("net.sourceforge.ganttproject.app").error(String.format("Can't find bundle: path=%s locale=i18n plugin", locale))
    null
  }
}
