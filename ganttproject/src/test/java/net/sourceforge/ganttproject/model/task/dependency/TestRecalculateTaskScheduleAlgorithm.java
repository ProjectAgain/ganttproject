...
public class TestRecalculateTaskScheduleAlgorithm extends TaskTestCase {
  ...
  public void testFinishFinishConstraintOnMovingEndDateForward()
    ...
    task1.setDuration(taskManager.createLength(
    ...
    task2.setDuration(taskManager.createLength(
      GregorianTimeUnitStack.DAY,
      3
    ));
    ...
    // task2   xxx
    assertEquals(
      CalendarFactory.createGanttCalendar(2000, 01, 05),
      task2.getEnd(),
      "Unexpected end of task=" + task2
    );
  }
  ...
  public void testFinishStartConstraintOnMovingEndDateBackward()
    ...
    task3.setDuration(taskManager.createLength(
      GregorianTimeUnitStack.DAY,
      1
    ));
    ...
    assertEquals(CalendarFactory.createGanttCalendar(2000, 01, 03),
                 task3.getStart(), "Unexpected value of start of task=" + task3
    );
  ...
  public void testFinishStartDependenciesOnMovingEndDateForward()
    ...
    assertEquals(CalendarFactory.createGanttCalendar(2000, 01, 05),
                 task3.getEnd(), "Unexpected value of end of task=" + task3
    );
  }
  ...
  public void testStartFinishConstraintOnMovingStartDateForward()
    ...
    taskManager.getAlgorithmCollection().getScheduler().run();
    assertEquals(
      CalendarFactory.createGanttCalendar(2000, 01, 04),
      task2.getEnd(),
      "Unexpected end of task=" + task2
    );
  }
  ...
  public void testStartStartConstraintOnMovingStartDateForward()
    ...
    assertEquals(
      CalendarFactory.createGanttCalendar(2000, 01, 04),
      task2.getStart(),
      "Unexpected start of task=" + task2
    );
  }
}
