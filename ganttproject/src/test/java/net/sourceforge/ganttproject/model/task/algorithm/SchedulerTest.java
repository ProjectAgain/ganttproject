...
public class SchedulerTest extends TaskTestCase {
  ...
  public void testChainOfSubtasks() throws Exception {
    ...
    Task[] tasks = new Task[]{
      createTask(TestSetupHelper.newMonday()),
      createTask(TestSetupHelper.newMonday()),
      createTask(TestSetupHelper.newMonday())};
    ...
    assertEquals(TestSetupHelper.newWednesday(), tasks[2].getEnd());
    assertEquals(TestSetupHelper.newWednesday(), tasks[0].getEnd());
  }
  ...
  public void testEarliestStartLaterThanStartDate() {
    ...
    Task[] tasks = new Task[]{createTask(TestSetupHelper.newMonday())};
    tasks[0].setThirdDateConstraint(TaskImpl.EARLIESTBEGIN);
    tasks[0].setThirdDate(TestSetupHelper.newWednesday());
    TaskDependency[] deps = new TaskDependency[0];
    DependencyGraph graph = createGraph(tasks, deps);
    ...
    assertEquals(TestSetupHelper.newWednesday(), tasks[0].getStart());
  }
  ...
  public void testEarliestStartLaterWinsToDependency() {
    ...
    Task[] tasks = new Task[]{createTask(TestSetupHelper.newMonday()), createTask(TestSetupHelper.newTuesday())};
    tasks[1].setThirdDateConstraint(TaskImpl.EARLIESTBEGIN);
    tasks[1].setThirdDate(TestSetupHelper.newWednesday());
    TaskDependency[] deps = new TaskDependency[]{createDependency(tasks[1], tasks[0])};
    DependencyGraph graph = createGraph(tasks, deps);
    ...
    assertEquals(TestSetupHelper.newWednesday(), tasks[1].getStart());
  }
  ...
  public void testIncomingFork() throws Exception {
    ...
    TaskDependency[] deps = new TaskDependency[]{
      ...
      createDependency(tasks[3], tasks[2]),
      createDependency(tasks[3], tasks[1])};
    DependencyGraph graph = createGraph(tasks, deps);
    ...
    assertEquals(TestSetupHelper.newTuesday(), tasks[1].getStart());
    assertEquals(TestSetupHelper.newWednesday(), tasks[3].getStart());
  }
  ...
  public void testInheritedDependenciesAreWeak() throws Exception {
    ...
    Task[] tasks = new Task[]{createTask(TestSetupHelper.newSunday()),
                              createTask(TestSetupHelper.newMonday()),
                              createTask(TestSetupHelper.newMonday()),
                              createTask(TestSetupHelper.newTuesday())};
    ...
    assertEquals(TestSetupHelper.newMonday(), tasks[1].getStart());
    assertEquals(TestSetupHelper.newWednesday(), tasks[1].getEnd());
    assertEquals(TestSetupHelper.newMonday(), tasks[2].getStart());
  ...
  public void testRhombus() throws Exception {
    ...
    assertEquals(TestSetupHelper.newTuesday(), tasks[1].getStart());
    assertEquals(TestSetupHelper.newTuesday(), tasks[3].getStart());
    assertEquals(TestSetupHelper.newWednesday(), tasks[2].getStart());
  ...
  public void testRubberDependency() throws Exception {
    Task[] tasks = new Task[]{createTask(TestSetupHelper.newMonday()),
                              createTask(TestSetupHelper.newMonday()),
                              createTask(TestSetupHelper.newWednesday())};
    TaskDependency dep10 = getTaskManager().getDependencyCollection()
                                           .createDependency(
                                             tasks[1], tasks[0], new FinishStartConstraintImpl(),
                                             TaskDependency.Hardness.RUBBER
                                           );
    TaskDependency dep20 = getTaskManager().getDependencyCollection()
                                           .createDependency(
                                             tasks[2], tasks[0], new FinishStartConstraintImpl(),
                                             TaskDependency.Hardness.RUBBER
                                           );
  ...
  public void testRubberFS_StrongFF() throws Exception {
    ...
    TaskDependency dep12 = getTaskManager().getDependencyCollection()
                                           .createDependency(
                                             tasks[1], tasks[2], new FinishFinishConstraintImpl(),
  ...
  public void testSimpleChain() throws Exception {
    ...
    Task[] tasks = new Task[]{createTask(TestSetupHelper.newMonday()),
                              ...
                              createTask(TestSetupHelper.newMonday())};
    TaskDependency[] deps =
      new TaskDependency[]{createDependency(tasks[2], tasks[1]), createDependency(tasks[1], tasks[0])};
    DependencyGraph graph = createGraph(tasks, deps);
  ...
  public void testTailHolidayTimeIsIgnored() throws Exception {
    ...
    Task[] tasks = new Task[]{createTask(TestSetupHelper.newFriday()),
                              createTask(TestSetupHelper.newFriday()),
                              createTask(TestSetupHelper.newMonday())};
  ...
  public void test_issue830() throws Exception {
    ...
    getTaskManager().getAlgorithmCollection().getRecalculateTaskScheduleAlgorithm().setEnabled(false);
    Task[] tasks = new Task[]{createTask(TestSetupHelper.newSunday()),
                              createTask(TestSetupHelper.newMonday(), 3),
                              createTask(TestSetupHelper.newWednesday()),
                              createTask(TestSetupHelper.newMonday())};
    TaskDependency[] deps = new TaskDependency[]{createDependency(tasks[1], tasks[0])};
