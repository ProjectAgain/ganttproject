...
public class DependencyTableModelTest extends TaskTestCase {
  ...
  public void testBasicDependencyAdd() {
    ...
    tableModel.setValueAt(
      new DependencyTableModel.TaskComboItem(task2), 0, DependencyTableModel.MyColumn.TASK_NAME.ordinal());
  ...
  public void testSubsequentDependeeChange_Issue1618() {
    ...
    tableModel.setValueAt(
      new DependencyTableModel.TaskComboItem(task1), 0, DependencyTableModel.MyColumn.TASK_NAME.ordinal());
